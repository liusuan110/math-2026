...
本目录收集 CUMCM 历年题目、附件数据与获奖解答，供备赛研读。
...
> 注：为各年作者实际参赛的题目（多为单题），含 `赛题说明.md` + `data/` + `code/` + `论文.pdf`。

### `recent-examples/`  近年完整实战（题目 PDF + 论文 + 代码 + 附件）
| 目录 | 题目 | 来源 |
|------|------|------|
| `2024-C题_农作物种植_广东二等奖/` | 2024 C 农作物种植策略 | [Autumnair007/2024-CUMCM-ProblemC](https://github.com/Autumnair007/2024-CUMCM-ProblemC) |
| `2024-B题_生产决策_江苏三等奖/` | 2024 B 生产过程决策 | [Cherzing/2024_CUMCM_B](https://github.com/Cherzing/2024_CUMCM_B) |
