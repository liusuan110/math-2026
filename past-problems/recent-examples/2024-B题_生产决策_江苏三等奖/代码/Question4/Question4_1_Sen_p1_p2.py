...
cases = [
    ...
    {'p1': 0.2, 'Cb1': 4, 'Cd1': 2, 'p2': 0.2, 'Cb2': 18, 'Cd2': 3, 'pf': 0.1, 'Ca': 6, 'Cdf': 3, 'Cl': 6, 'Ct': 5, 'S': 56},
    {'p1': 0.3, 'Cb1': 4, 'Cd1': 2, 'p2': 0.3, 'Cb2': 18, 'Cd2': 3, 'pf': 0.1, 'Ca': 6, 'Cdf': 3, 'Cl': 6, 'Ct': 5, 'S': 56},
    {'p1': 0.4, 'Cb1': 4, 'Cd1': 2, 'p2': 0.4, 'Cb2': 18, 'Cd2': 3, 'pf': 0.1, 'Ca': 6, 'Cdf': 3, 'Cl': 6, 'Ct': 5, 'S': 56},
    {'p1': 0.5, 'Cb1': 4, 'Cd1': 2, 'p2': 0.5, 'Cb2': 18, 'Cd2': 3, 'pf': 0.1, 'Ca': 6, 'Cdf': 3, 'Cl': 6, 'Ct': 5, 'S': 56},
    {'p1': 0.05, 'Cb1': 4, 'Cd1': 2, 'p2': 0.05, 'Cb2': 18, 'Cd2': 3, 'pf': 0.1, 'Ca': 6, 'Cdf': 3, 'Cl': 6, 'Ct': 5, 'S': 56}
]
...
for D1, D2, Df, Dd, Dr1, Dr2, Dr, Dc1, Dc2 in itertools.product([0, 1], repeat=9):
    for case in cases:
        ...
        C_det = n*N1*Df*case['Cdf']+\
                (D1*(1-case['p1'])*N)*(Df*Dd*case['pf']*n*(case['Cd1']*Dc1*(1-D1)+(case['Cd2']*Dc2*(1-D2))))+\
                D1*(1-case['p1'])*N*(1-Df)*Dr*case['pf']*(case['Cd1']*Dr1*(1-D1)+case['Cd2']*Dr2*(1-D2))*n+\
